 ...
 *
 * @version $Id: CertDistServlet.java 22863 2016-02-25 11:42:04Z samuellb $
 */
@Controller
public class CertDistController  {

    private static final long serialVersionUID = 1L;

    private static Logger log = LoggerFactory.getLogger(CertDistController.class);
    ...
    public void doGet(HttpServletRequest req,  HttpServletResponse res) throws IOException, ServletException {
        ...
        log.info(">>>>>>>>/webdist/certdist: commond="+command);
