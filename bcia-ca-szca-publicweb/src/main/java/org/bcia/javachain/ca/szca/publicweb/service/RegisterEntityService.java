...
public interface RegisterEntityService {
	static final int ISREQUIRED = 2;
    static final int MODIFYABLE = 3;
    static final String ENTITY_SUBJECT_DN_ORDER = "SUBJECTDNFIELDORDER";
	static final String ENTITY_SUBJECT_SAN_ORDER = "SUBJECTALTNAMEFIELDORDER";
	static final String ENTITY_SUBJECT_DIR_ORDER = "SUBJECTDIRATTRFIELDORDER";
