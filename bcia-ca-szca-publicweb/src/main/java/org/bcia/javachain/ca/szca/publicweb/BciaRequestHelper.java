...
public class BciaRequestHelper {
    ...
    private static final org.slf4j.Logger log = LoggerFactory.getLogger(BciaRequestHelper.class);
   ...
   // private ServletDebug debug;
	...
	public static final int ENCODED_CERTIFICATE_CHAIN = 4;
	 ...
	 public BciaRequestHelper(AuthenticationToken administrator) {
     ...
     */
//    public BciaRequestHelper(AuthenticationToken administrator, ServletDebug debug) {
//        this.administrator = administrator;
////        this.debug = debug;
//    }
...
//            }
    ...
    public static void sendNewCertToIEClient(byte[] b64cert, OutputStream out, ServletContext sc,
        ...
        while (true) {
            ...
            if (line.indexOf("cert =") < 0) {
                ...
                BciaRequestHelper.ieCertFormat(b64cert, ps);
            }
        }
    ...
    public static void sendNewB64Cert(byte[] b64cert, HttpServletResponse out, String beginKey, String endKey)
        throws IOException {
        BciaRequestHelper.sendNewB64File(b64cert, out, "cert.pem", beginKey, endKey);
    } // sendNewB64Cert
