...
import cn.net.bcia.bcca.common.BaseCodeData;
import cn.net.bcia.bcca.common.BaseCodeService;
...
public class InitGlobalConfig {
	...
	public void initSysConfig() {
		...
		BaseCodeData bc = service.getBasecode("URL", "PUBLIC_URL");
		if(bc!=null)
			AdminWebConstants.PUBLIC_URL =bc.getValue(); 
	}
