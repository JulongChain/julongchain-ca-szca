					...
					<div class="span12">
						<div class="portlet box blue" id="form_wizard_1">
							...
							<div class="portlet-body form">
								<form action="updateCertProcess.html" class="form-horizontal" id="submit_form" name="submit_form" method="post">
									<!-- caType: 1=X509,2=CVC -->
									<div class="form-wizard">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												<div class="control-group">
													<label class="control-label">实体流程Id：</label>
													<div class="controls">
														${cpd.processId } 
														<input type="hidden" name="processId" id="processId" value="${cpd.processId }"/> 
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">实体流程名称：<span class="required">*</span></label>
													<div class="controls">
														<input type="text" onchange="processNameChange()" name="processName" id="processName" value="${cpd.processName }"/> 
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														<textarea rows="4" cols="6" name="memo">${cpd.memo }</textarea>
													</div>
												</div>
										...
										<div class="form-actions clearfix">
											<input type="button" class="btn blue" id="submitBtn" onclick="submit_form.submit()" value="提交"/>
											<input type="button" class="btn blue" id="removeBtn" onclick="delCertProcess()" value="删除"/>
...
<script>  
	...
	function delCertProcess(){
		if(window.confirm('确定删除证书流程？')){
			window.location.href ="${pageContext.request.contextPath}/ra/delCertProcess.html?processId=${cpd.processId}";
	    }
	}
	
	$('#certProfileName').val('${cpd.certProfileName}');
	$('#endEntityProfileName').val('${cpd.endEntityProfileName}');
	$('#caName').val('${cpd.caName}');
	$('#status').val('${cpd.status}');
</script>
