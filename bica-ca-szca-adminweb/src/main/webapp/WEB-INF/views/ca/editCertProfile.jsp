								...
								<form action="handleCertProfile.html" class="form-horizontal" id="submit_form" name="submit_form" method="post">
									...
									<div class="form-wizard">
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input	type="hidden" name="type" id="type" value="${profileMap['type'] }"/>
														<input type="button" class="btn blue" value="终端实体" id="profiletype1" onclick="changeProfileType('1')"/>
														<input type="button" class="btn blue" value="子CA" id="profiletype2" onclick="changeProfileType('2')"/>	
														<input type="button" class="btn blue" value="根CA" id="profiletype8" onclick="changeProfileType('8')"/>	
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">可用密钥算法</label>
													<div class="controls">
														<select name="availablekeyalgorithms" id="availablekeyalgorithms" multiple="multiple">
											 	...
											 	<div class="control-group">
													...
													<div class="controls">
														<select name="availableeccurves" id="availableeccurves" multiple="multiple">
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="availablebitlengths" name="availablebitlengths" multiple="multiple" size="5">	
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="signaturealgorithm" name="signaturealgorithm">	
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="validity" required="required" value="${profileMap['validity']}" data-title="validity" />天
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="checkbox" name="allowvalidityoverride" id="allowvalidityoverride" value="true"/>允许
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														<input type="checkbox" name="allowextensionoverride" id="allowextensionoverride" value="true"/>允许
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls">
														<input type="checkbox" name="allowdnoverride" id="allowdnoverride" value="true"/>允许
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="allowdnoverridebyeei" id="allowdnoverridebyeei" value="true"/>允许
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="allowkeyusageoverride" id="allowkeyusageoverride" value="true"/>允许
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="allowbackdatedrevokation" id="allowbackdatedrevokation" value="true"/>允许
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group" id="usecertificatestorageDiv" style="display: none;">
													...
													<div class="controls"> 
														<input type="checkbox" name="usecertificatestorage" id="usecertificatestorage" value="true"/>使用
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group" id="storecertificatedataDiv" style="display: none;">
													...
													<div class="controls"> 
														<input type="checkbox" name="storecertificatedata" id="storecertificatedata" value="true"/>使用
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="usebasicconstrants" id="usebasicconstrants" value="true"/>使用
														<input type="checkbox" name="basicconstraintscritical" id="basicconstraintscritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group" id="pathLen" style="display: none;">
													...
													<div class="controls"> 
														<input type="checkbox" name="usepathlengthconstraint" id="usepathlengthconstraint" value="true" onchange="pathLenChange()"/>使用
														&nbsp;&nbsp;&nbsp;长度值 ：<input type="text" name="pathlengthconstraint" style="width: 50px" id="pathlengthconstraint" value="${profileMap['pathlengthconstraint']}"/>
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="useauthoritykeyidentifier" id="useauthoritykeyidentifier" value="true"/>使用
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="usesubjectkeyidentifier" id="usesubjectkeyidentifier" value="true"/>使用
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="useldapdnorder" id="useldapdnorder" value="true"/>使用
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="usekeyusage" id="usekeyusage" value="true"/>使用
														<input type="checkbox" name="keyusagecritical" id="keyusagecritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
													<div class="controls"> 
														密钥用法: 
													...
													<div class="controls"> 
														<input type="checkbox" name="keyusage" id="keyusage0" value="0"/>数字签名
														<input type="checkbox" name="keyusage" id="keyusage1" value="1"/>不可抵赖  
														<input type="checkbox" name="keyusage" id="keyusage2" value="2"/>密钥加密
													</div>
													<div class="controls">  
														<input type="checkbox" name="keyusage" id="keyusage3" value="3"/>数据加密       
														<input type="checkbox" name="keyusage" id="keyusage4" value="4"/>密钥协议
														<input type="checkbox" name="keyusage" id="keyusage5" value="5"/>密钥证书签名
													</div>
													<div class="controls"> 
														<input type="checkbox" name="keyusage" id="keyusage6" value="6"/>CRL签名  
														<input type="checkbox" name="keyusage" id="keyusage7" value="7"/>只用于加密
														<input type="checkbox" name="keyusage" id="keyusage8" value="8"/>只用于解密
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="useextendedkeyusage" id="useextendedkeyusage" value="true"/>使用
														<input type="checkbox" name="extendedkeyusagecritical" id="extendedkeyusagecritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls"> 
														<select id="extendedkeyusage" name="extendedkeyusage"　id="extendedkeyusage" multiple="multiple">	
												...
												<div class="control-group" >
													...
													<div class="controls"> 
														<input type="checkbox" name="usecertificatepolicies" id="usecertificatepolicies" value="true" onchange="cpChange()"/>使用
														<input type="checkbox" name="certificatepoliciescritical" id="certificatepoliciescritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group" id="cpDiv" style="display: none;">
													...
													<div class="controls"> 
														证书策略ID：<input type="text" name="cpId" id="cpId" />&nbsp;&nbsp;
														<input type="button" class="btn blue" onclick="addCP()" value="添加"  />												
													</div>
													<div class="controls"> 
														<input type="radio" name="qualifier" checked="checked" value="0" onchange="qualifierChange()"/>无策略限定符											
														<input type="radio" name="qualifier" value="1" onchange="qualifierChange()"/>用户通知
														<input type="radio" name="qualifier" value="2" onchange="qualifierChange()"/>CPS
													</div> 
													<div class="controls" id="qualifierDiv" style="display: none;"> 
														<input type="text" name="qualifierVal" id="qualifierVal"/>								
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="usesubjectalternativename" id="usesubjectalternativename" value="true"/>使用
														<input type="checkbox" name="subjectalternativenamecritical" id="subjectalternativenamecritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="useissueralternativename" id="useissueralternativename" value="true"/>使用
														<input type="checkbox" name="issueralternativenamecritical" id="issueralternativenamecritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="usecrldistributionpoint" id="usecrldistributionpoint" value="true" onchange="crlChange()"/>使用
														<input type="checkbox" name="crldistributionpointcritical" id="crldistributionpointcritical" value="true"/>关键
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group" id="defaultCrlDiv" style="display: none;">
													...
													<div class="controls"> 
														<input type="checkbox" name="usedefaultcrldistributionpoint" id="usedefaultcrldistributionpoint" value="true" onchange="defaultCrlChange()"/>使用
													</div>
												</div>
												<div class="control-group" id="crlDiv" style="display: none;">
													<label class="control-label">CRL发布点URI</label>
													<div class="controls"> 
														<input type="text" name="crldistributionpointuri" id="crldistributionpointuri" value="${profileMap['crldistributionpointuri']}" />
													</div>
												</div>
												<div class="control-group" id="crlIssuerDiv" style="display: none;">
													<label class="control-label">CRL发布点者</label>
													<div class="controls"> 
														<input type="text" name="crlissuer" id="crlissuer" value="${profileMap['crlissuer']}" />
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls"> 
														<input type="checkbox" name="useauthorityinformationaccess" id="useauthorityinformationaccess" value="true" onchange="aiaChange()"/>使用
														<span class="help-inline"></span>
													</div>
												</div>
												<div class="control-group" id="defaultOCSPDiv" style="display: none;">
													...
													<div class="controls"> 
														<input type="checkbox" name="usedefaultocspservicelocator" id="usedefaultocspservicelocator" value="true" onchange="defaultOCSPChange()"/>使用
													</div>
												</div>
												<div class="control-group" id="ocspDiv" style="display: none;">
													<label class="control-label">OCSP URI</label>
													<div class="controls"> 
														<input type="text" name="ocspservicelocatoruri" id="ocspservicelocatoruri" value="${profileMap['ocspservicelocatoruri']}" />
													</div>
												</div>
												<!-- 
												...
												<div class="control-group" id="issuerDiv" style="display: none;">
													...
													<div class="controls"> 
														<input type="text" name="issueruri" id="issueruri" value="" />&nbsp;&nbsp;
														<input type="button"  class="btn blue" id="addIssuerButton" value="添加" onclick="addIssuer()"/>
													</div>
												</div>
												<h4 class="block">其他扩展项</h4>
												<div class="control-group">
													<label class="control-label">OCSP不撤销</label>
													<div class="controls"> 
														<input type="checkbox" name="useocspnocheck" id="useocspnocheck" value="true"/>使用
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">介质编号扩展项</label>
													<div class="controls"> 
														<input type="checkbox" name="usecardnum" id="usecardnum" value="true"/>使用
													</div>
												</div>
												<div class="control-group">
													<label class="control-label">自定义扩展项</label>
													<div class="controls">
														<select id="usecustomextensions" name="usecustomextensions" multiple="multiple" size="5">	
															<c:forEach items="${certificateExtensions }" var="ce">
																<option value="${ce.id }">${ce.displayName }</option>
															</c:forEach>
														</select>
														<input type="button" value="取消所有选中项" onclick="uncheckAllExtension();"/> 
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">
														<select id="availablecas" name="availablecas" multiple="multiple">	
										...
										<div class="form-actions clearfix">
											<input type="button" class="btn blue" onclick="submit_form.submit()" value="提交"/>
...
<script>
	...
	function uncheckAllExtension(){
		 var opts=document.getElementById("usecustomextensions");
		...
		if(cpVals != null){
			...
			for(var i=0;i<cpVal.length;i++){
				...
				if(cpArr.length == 3){
					...
					var str = '<input type="button" class="btn blue" value="删除" onclick=removeCP("' + cpArr[0] + i + '","' + cpValDeal + '")>';
					cell3.innerHTML = str;
	...
	function changeProfileType(t){
		...
		if(t == '1'){
			...
			document.getElementById('profiletype1').className = 'btn white';
			document.getElementById('profiletype2').className = 'btn blue';
			document.getElementById('profiletype8').className = 'btn blue';
		...
		if(t == '2'){
			...
			document.getElementById('profiletype8').disabled = '';
			document.getElementById('profiletype1').className = 'btn blue';
			document.getElementById('profiletype2').className = 'btn white';
			document.getElementById('profiletype8').className = 'btn blue';
		...
		if(t == '8'){
			...
			document.getElementById('profiletype1').className = 'btn blue';
			document.getElementById('profiletype2').className = 'btn blue';
			document.getElementById('profiletype8').className = 'btn white';
			document.getElementById('pathLen').style.display = 'block';
			document.getElementById('usecertificatestorageDiv').style.display = 'none'
			document.getElementById('storecertificatedataDiv').style.display = 'none'
		}
		...
		if(issuerVals != null){
			...
			for(var i=0;i<issuerVal.length;i++){
				if(issuerVal[i] != null && issuerVal[i].length > 0){
					...
					var str = '<input type="button" class="btn blue" name="issuerRemoveBtn" value="删除" onclick=removeIssuer("issuer'+ i + '","' + issuerVal[i].trim() + '")>';
					cell2.innerHTML = str;
				}	 
			}
		}
	...
	//证书模板类型
	changeProfileType("${profileMap['type'] }");
	...
	//介质编号
	var isUseCardNum = "${profileMap['usecardnumber']}";
	checkBoxInit(isUseCardNum,'usecardnum');
	//自定义扩展项
	var extenstions = "${profileMap['usedcertificateextensions']}";
	multipleSelected(extenstions, 'usecustomextensions');
	//可用CA
