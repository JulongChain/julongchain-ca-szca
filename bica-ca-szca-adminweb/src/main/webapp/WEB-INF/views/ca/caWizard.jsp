							...
							<form action="createNewCA.html" class="form-horizontal" id="submit_form" name="submit_form" method="post">
								...
								<div class="form-wizard">
									<div class="navbar steps">
										<div class="navbar-inner">
											<ul class="row-fluid">
												...
												<li class="span3"><a href="#tab3" data-toggle="tab" class="step"> <span class="number">3</span> <span class="desc"><i class="icon-ok"></i>配置VA</span>
												</a></li>
									...
									<div id="bar" class="progress progress-success progress-striped">
										<div class="bar" style="background: #4b8df8;"></div>
									</div>
									<div class="tab-content">
										...
										<div class="tab-pane" id="tab2">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span6 m-wrap" name="validityString" value="3650"/>天 <span class="help-inline"></span>
												</div>
											</div>
											<div class="control-group">
											...
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" checked="checked" name="isDoEnforceUniquePublicKeys" value="true"/>强制 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" name="isDoEnforceUniqueDistinguishedName" value="true"/>强制 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" name="isDoEnforceUniqueSubjectDNSerialnumber" value="true"/>强制 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" checked="checked" name="useUserStorage" value="true"/>使用 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap"  checked="checked" name="useCertificateStorage" value="true"/>使用 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" name="useLdapDnOrder" value="true"/>使用 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" name="useUtf8PolicyText" value="true"/>使用 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio">
														<input type="checkbox" class="span6 m-wrap" name="usePrintableStringSubjectDn" value="true"/>使用 <span class="help-inline"></span>
													</label>
												</div>
											</div>
										...
										<div class="tab-pane" id="tab3">
											<h3 class="block">配置VA信息</h3>
											<div class="control-group">
												<label class="control-label">CRL周期</label>
												<div class="controls">
													<input type="text" class="span6 m-wrap" name="crlPeriod" value="1"/>天 <span class="help-inline"></span>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
                                                    ...
                                                    <input type="text" class="span6 m-wrap" name="akid" />
                                                     -->
													<label class="radio"> <input type="checkbox" checked="checked" name="useAuthorityKeyIdentifier" value="true" data-title="使用" /> 使用
													</label>
													<label class="radio"> <input type="checkbox" name="authorityKeyIdentifierCritical" value="true" data-title="关键"  /> 关键
													</label> <span class="help-inline"></span>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<label class="radio"> <input type="checkbox" checked="checked" name="useCrlNumber" value="true" data-title="使用" /> 使用
													</label>

													<label class="radio"> <input type="checkbox" name="crlNumberCritical" value="true" data-title="关键"  /> 关键 <span class="help-inline"></span>
													</label>
												</div>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span6 m-wrap" name="defaultCrlDistpoint" value=""/> <span class="help-inline"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">默认CRL颁发者</label>
												<div class="controls">
													<input type="text" class="span6 m-wrap" name="defaultCrlIssuer" value=""/> <span class="help-inline"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">默认OCSP URI</label>
												<div class="controls">
													<input type="text" class="span6 m-wrap" name="defaultOcspLocator" value=""/> <span class="help-inline"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">默认颁发者CA URI</label>
												<div class="controls">
													<input type="text" class="span6 m-wrap" name="authorityInformationAccess" value=""/> <span class="help-inline"></span>
												</div>
											</div>
										</div>
										...
										<div class="tab-pane" id="tab4">
											...
											<div class="control-group">
												...
												<div class="controls">
													<span class="text display-value" data-display="signedBy"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">证书有效期</label>
												<div class="controls">
													<span class="text display-value" data-display="validityString"></span>天
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">主题别名</label>
											...
											<div class="control-group">
												<label class="control-label">默认CRL分发点URI</label>
												<div class="controls">
													<span class="text display-value" data-display="defaultCrlDistpoint"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">默认CRL颁发者</label>
												<div class="controls">
													<span class="text display-value" data-display="defaultCrlIssuer"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">默认OCSP URI</label>
												<div class="controls">
													<span class="text display-value" data-display="defaultOcspLocator"></span>
												</div>
											</div>
											<div class="control-group">
												<label class="control-label">默认CA颁发者URI</label>
												<div class="controls">
													<span class="text display-value" data-display="authorityInformationAccess"></span>
												</div>
											</div>
											<!--
                                            <div class="control-group">
									...
									</a> <a href="#" class="btn blue button-submit" onclick="submit_form.submit()"> 提交 <i class="m-icon-swapright m-icon-white"></i>
									</a>
									</div>
								</div>
							</form>
