...
import org.bcia.javachain.ca.szca.common.cesecore.certificates.ca.CaSession;
import org.bcia.javachain.ca.szca.common.cesecore.configuration.GlobalConfigurationSession;


public class BciaRAAuthorization implements Serializable {
    ...
    public BciaRAAuthorization(AuthenticationToken admin, GlobalConfigurationSession globalConfigurationSession, AccessControlSessionLocal authorizationsession, 
