...
package org.bcia.javachain.ca.szca.common.bcca.core.ejb.authentication.web;
...
public class WebAuthenticationProviderSessionBean implements WebAuthenticationProviderSessionLocal {
    ...
    @Autowired
    private org.bcia.javachain.ca.szca.common.cesecore.audit.log.SecurityEventsLoggerSessionLocal securityEventsLoggerSession;
