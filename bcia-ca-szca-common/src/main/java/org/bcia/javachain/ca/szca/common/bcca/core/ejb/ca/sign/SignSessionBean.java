...
package org.bcia.javachain.ca.szca.common.bcca.core.ejb.ca.sign;
...
public class SignSessionBean implements SignSessionLocal, SignSessionRemote {
    ...
    @Autowired
    private org.bcia.javachain.ca.szca.common.cesecore.certificates.certificate.CertificateCreateSessionLocal certificateCreateSession;
    @EJB
    private org.bcia.javachain.ca.szca.common.bcca.core.ejb.ra.EndEntityAccessSessionLocal endEntityAccessSession;
    @Autowired
    private org.bcia.javachain.ca.szca.common.bcca.core.ejb.ca.auth.EndEntityAuthenticationSessionLocal endEntityAuthenticationSession;
    @Autowired
    ...
    @Autowired
    private org.bcia.javachain.ca.szca.common.cesecore.certificates.crl.CrlStoreSessionLocal crlStoreSession;
    @Autowired
    private org.bcia.javachain.ca.szca.common.cesecore.keys.token.CryptoTokenManagementSessionLocal cryptoTokenManagementSession;
    @Autowired
