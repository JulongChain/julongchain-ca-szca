...
import org.bcia.javachain.ca.szca.common.cesecore.authorization.access.AccessTree;
import org.bcia.javachain.ca.szca.common.cesecore.authorization.access.AccessTree;
 ...
 * 
 * @version $Id: AccessTreeCache.java 20608 2015-02-02 11:43:15Z jeklund $
 * 
 */
public class AccessTreeCache {

    /*
     * Cache of authorization data. This cache may be unsynchronized between multiple instances of EJBCA, but is com.szca.common to all threads in the same VM.
     ...
     */
    public synchronized void updateAccessTree(Collection<org.cesecore.roles.RoleData> roles, int authorizationTreeUpdateNumber) {
        if (accessTree == null) {
