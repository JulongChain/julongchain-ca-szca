 ...
 * 
 * @version $Id: IntegrityProtectedDevice.java 18194 2013-11-21 18:09:12Z jeklund $
 */
public class IntegrityProtectedDevice implements AuditLogDevice {
	...
	@Autowired
	IntegrityProtectedLoggerSessionLocal logBean;
	...
	public void log(TrustedTime trustedTime, EventType eventType, EventStatus eventStatus, ModuleType module, ServiceType service, String authToken, String customId,
		...
		logBean.log(trustedTime, eventType, eventStatus, module, service, authToken, customId, searchDetail1, searchDetail2, additionalDetails, properties);
	}
