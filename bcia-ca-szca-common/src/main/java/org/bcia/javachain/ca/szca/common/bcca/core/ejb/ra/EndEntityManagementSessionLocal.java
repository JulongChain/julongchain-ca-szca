...
public interface EndEntityManagementSessionLocal extends EndEntityManagementSession {
    ...
    int findAllUsersTotal(AuthenticationToken admin) throws IllegalQueryException ;

  
    Collection<EndEntityInformation> findAllUsers(AuthenticationToken admin, int currentPage, int rowsPerPage) ;
    /**
