...
public class OcspClient {
	...
	public static final String OCSP_URL = "http://127.0.0.1:8080/OcspServer-1/ocsp";
...
/*
	...
	private static String getCertAccessUrl(X509Certificate certificate, String oid) throws Exception{
	 ...
	 public static void main(String[] args) throws Exception{
		...
		String SUB_DIR = "D:\\cacert\\cert\\sub\\";
		String EE_DIR = "D:\\cacert\\cert\\entity\\";
		String OCSP_DIR = "D:\\cacert\\cert\\ocsp\\";
		String base64UserCert = new String(FileUtils.readFile(new File(EE_DIR + "20180509151813273lm8ml02q7ll9az8_ec.cer")));
		String base64IssuerCert = new String(FileUtils.readFile(new File(SUB_DIR + "subca_ec.cer")));
